...
"""
    ...
    def add_new_area(self):
        ...
        try:
            ...
            logger.info(f"新しい監視エリアを追加しました: {new_area['name']}")
            
        except Exception as e:
            logger.error(f"監視エリア追加エラー: {e}")
            messagebox.showerror("エラー", f"監視エリアの追加に失敗しました: {e}")
    ...
    def show_chat_setup_instructions(self) -> bool:
        ...
        try:
            ...
            instruction_dialog.geometry("+%d+%d" % (
