...
version = "2.0.0"
edition = "2021"
rust-version = "1.82"  # 最新安定版

[dependencies]
# 画像処理
image = "0.25.9"           # 画像読み込み・操作
...
# 自動操作
enigo = "0.6.1"            # クロスプラットフォーム入力シミュレーション

# システムトレイ
tray-item = "0.10"        # システムトレイアイコン

# GUI（設定ツール）
egui = "0.33.2"            # 即時モードGUI
eframe = "0.33.2"          # eGuiアプリケーションフレームワーク
