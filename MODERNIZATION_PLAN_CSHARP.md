...
- ✅ **パフォーマンス**: JITコンパイル、AOTコンパイル対応（.NET 10でさらに高速化）
...
- ⚠️ **起動時間**: JIT起動で若干遅い
  - **対策**: ReadyToRun, AOTコンパイル（.NET 10で大幅改善）
...
<Project Sdk="Microsoft.NET.Sdk">
  ...
  <ItemGroup>
    <!-- 画像処理 -->
    <PackageReference Include="OpenCvSharp4" Version="4.10.0.20251101" />
    <PackageReference Include="OpenCvSharp4.runtime.win" Version="4.10.0.20251101" />
...
- **リンター**: Roslyn Analyzers（.NET 10標準）
