...
class KiroSetupApp:
    ...
    def create_ui(self):
        ...
        # タイトル
        title_label = tk.Label(main_frame, text="Kiro-IDE自動復旧システム設定", 
                              font=("Arial", 16, "bold"))
        title_label.pack(pady=(0, 20))
        
        # 監視エリア設定セクション
        monitor_frame = tk.LabelFrame(main_frame, text="監視エリア設定", padx=10, pady=10)
        ...
        self.monitor_btn = tk.Button(monitor_frame, text="監視エリアを設定", 
        ...
        self.save_btn = tk.Button(save_frame, text="設定を保存", 
        ...
        self.test_btn = tk.Button(test_frame, text="復旧コマンドテスト", 
